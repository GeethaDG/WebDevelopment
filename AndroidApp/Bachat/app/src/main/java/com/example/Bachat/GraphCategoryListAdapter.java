...
public class GraphCategoryListAdapter  extends ArrayAdapter<GraphCategory>{
     ...
     * @param objects
     */
    public GraphCategoryListAdapter(Context context, int resource, ArrayList<GraphCategory> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Float Percentage = getItem(position).getPercentage();
        ...
        if(convertView == null){
            ...
            holder.percentage = (TextView) convertView.findViewById(R.id.percent);
