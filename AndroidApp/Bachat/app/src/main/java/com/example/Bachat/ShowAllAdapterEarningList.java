...
public class ShowAllAdapterEarningList extends ArrayAdapter<EarningListItem> {
    ...
    public ShowAllAdapterEarningList(Context context, int resource, ArrayList<EarningListItem> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //ViewHolder object
        ShowAllAdapterEarningList.ViewHolder holder;

        if(convertView == null){
            LayoutInflater inflater = LayoutInflater.from(mContext);
            convertView = inflater.inflate(mResource, parent, false);
            holder= new ShowAllAdapterEarningList.ViewHolder();
            ...
            holder = (ShowAllAdapterEarningList.ViewHolder) convertView.getTag();
            result = convertView;
        }
