...
public class EditUpdateScreen extends AppCompatActivity {
    DatabaseHelper myDb;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_update_screen);
       // TextView editid =(TextView) findViewById(R.id.textViewEditId);
        ...
        final Spinner editspnmodeofpayment = (Spinner) findViewById(R.id.spnEditMOP);
        ...
        editdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(EditUpdateScreen.this,
        ...
        Spinner editSpinnerMOP = (Spinner) findViewById(R.id.spnEditMOP);
       ...
       // editnote.setText(note.toString());
        ...
        addnote =(Button) findViewById(R.id.btnEditAddNotes);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(TAG, "onClick: value of edited date is "+ updatedd );
                ...
                {
                    Toast.makeText(EditUpdateScreen.this, "Please enter amount ", Toast.LENGTH_SHORT).show();
                }
                else if(Float.parseFloat(updateda) >= 99999999f)
                {
                    Toast.makeText(EditUpdateScreen.this, "Please enter amount which is smaller than 99999999", Toast.LENGTH_SHORT).show();
                }
                else if(Float.parseFloat(updateda) < 0f)
                {
                    Toast.makeText(EditUpdateScreen.this, "Please enter amount which is greater than 0", Toast.LENGTH_SHORT).show();
                }
                else if(Float.parseFloat(updateda) >= 0f && Float.parseFloat(updateda) < 99999999f && !(updateda.length() == 0))
                {
                    UpdateData();
                }
        ...
        fab_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EditUpdateScreen.this, MainActivity.class);
                startActivity(intent);
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(EditUpdateScreen.this)
                .setMessage(message)
    ...
    public void UpdateData() {
       // updateButton.setOnClickListener(
             //   new View.OnClickListener() {
                   // @Override
                    //public void onClick(View v) {
                        boolean isUpdate = myDb.updateData(id,splitstring[1],updatedsc,updatedmop,updateda,updatedd,updatedn,updatedCurr,contactName,sb.toString(), sb1.toString());
                        Log.d(TAG, "update string is : "+updatedsc+" "+updateda+" "+updatedd+ " "+updatedn);
                        if(isUpdate == true) {
                            Toast.makeText(EditUpdateScreen.this, "Data Update", Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(EditUpdateScreen.this, MainActivity.class);
                            intent.putExtra("open_view_all_expenses", "Open view all expenses screen");
                            startActivity(intent);
                        }
                        else {
                            Toast.makeText(EditUpdateScreen.this, "Data not Updated", Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(EditUpdateScreen.this, MainActivity.class);
                            intent.putExtra("open_view_all_expenses", "Open view all expenses screen");
                            startActivity(intent);
                        }
