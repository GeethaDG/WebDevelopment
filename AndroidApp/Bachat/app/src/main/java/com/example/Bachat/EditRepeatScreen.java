...
public class EditRepeatScreen extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final TextView editsubcategory = (TextView) findViewById(R.id.textViewEditSubcategoryRepeat);
        ...
        //final Spinner editspnCurrency = (Spinner) findViewById(R.id.spnEditCurrRepeat);
        ...
        editdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(EditRepeatScreen.this,
        ...
        Spinner editSpinnerMOP = (Spinner) findViewById(R.id.spnEditMOPRepeat);
        ...
        repeatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //updatedcurr = currencySpinner.getSelectedItem().toString();
    ...
    public void RepeatData() {
        ...
        //  @Override
        // public void onClick(View v) {
        boolean insertRow = myDb.repeatData(splitstring[1],updatedsc,updatedmop,updateda,updatedd,updatedn,updatedCurr,contactName,sb.toString(), sb1.toString());
