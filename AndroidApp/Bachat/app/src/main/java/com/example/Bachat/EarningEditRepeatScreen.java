...
public class EarningEditRepeatScreen extends AppCompatActivity {
    DatabaseHelper myDb;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.earning_edit_repeat_screen);
        ...
        //final Spinner editSpnCurr = (Spinner) findViewById(R.id.spnEditCurrRepeat);
        final EditText editamount = (EditText) findViewById(R.id.editTextEditAmountRepeat);
        ...
        editdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(EarningEditRepeatScreen.this,
        ...
        addnote =(Button) findViewById(R.id.btnEditAddNoteRepeat);
        ...
        repeatButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                updatedcurr = editSpinnerMOP.getSelectedItem().toString();

                if(updatedea.length() == 0)
                {
                    Toast.makeText(EarningEditRepeatScreen.this, "Please enter amount ", Toast.LENGTH_SHORT).show();
                }
                else if(Float.parseFloat(updatedea) >= 99999999f)
                {
                    Toast.makeText(EarningEditRepeatScreen.this, "Please enter amount which is smaller than 99999999", Toast.LENGTH_SHORT).show();
                }
                else if(Float.parseFloat(updatedea) < 0f)
                {
                    Toast.makeText(EarningEditRepeatScreen.this, "Please enter amount which is greater than 0", Toast.LENGTH_SHORT).show();
                }
        ...
        fab_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EarningEditRepeatScreen.this, MainActivity.class);
                startActivity(intent);
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(EarningEditRepeatScreen.this)
                .setMessage(message)
    ...
    public void RepeatData() {
        ...
        //  @Override
        // public void onClick(View v) {
        boolean insertRow = myDb.repeatDataEarning(splitstring[1],updatedmop,updatedea,updateded,updatedn,updatedcurr,contactName,sb.toString(), sb1.toString());
        Log.d(TAG, "repeat string is : "+splitstring[1]+" "+updatedmop+" "+updatedea+" "+updateded);
        if(insertRow) {
            Toast.makeText(EarningEditRepeatScreen.this, "Data Repeated", Toast.LENGTH_LONG).show();
            Intent intent = new Intent(EarningEditRepeatScreen.this, MainActivity.class);
            intent.putExtra("open_view_all_income", "Open view all income screen");
            startActivity(intent);
        }
        else {
            Toast.makeText(EarningEditRepeatScreen.this, "Data not repeated", Toast.LENGTH_LONG).show();
            Intent intent = new Intent(EarningEditRepeatScreen.this, MainActivity.class);
            intent.putExtra("open_view_all_income", "Open view all income screen");
            startActivity(intent);
        }
